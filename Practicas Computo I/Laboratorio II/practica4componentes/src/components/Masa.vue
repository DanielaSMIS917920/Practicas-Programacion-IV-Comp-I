<template>
  <div>
    <div class="container pt-3">
      <h1>CONVERSOR DE UNIDADES DE MASA</h1>
      <div class="row">
        <div class="col-lg-12">
      ...
      <div class="text-center pt-4"> 
        <h6 v-if="cantidad > 0"> <!--Mostramos la respuesta dentro de un H6-->
          <span class="badge badge-success">{{ cantidad }} {{ tengo }}</span> <!--Cantidad a convertir-->
          <span class="badge badge-dark"> SON </span>
          <span class="badge badge-success">{{ getTotal(total) }} {{ quiero }}</span> <!--Respuesta de la conversion-->
        </h6>
      </div>
    </div>
  </div>
